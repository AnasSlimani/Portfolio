            ...
            <div className={`container mx-auto flex flex-col md:flex-row items-center justify-between gap-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="md:w-1/2 text-center md:text-left">
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight">
                        Hi, I'm <span className="text-cyan-400">Anas Slimani</span>
                        <br />
                        Software Engineering Student
                    </h1>
                    <p className="mt-6 text-lg text-slate-400 max-w-xl mx-auto md:mx-0">
                        Seeking a final-year internship in Full-Stack Development & DevOps. I’m passionate about building reliable, scalable applications and designing modern CI/CD pipelines that enhance software quality and delivery.
                    </p>
